    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @if(Auth::check())
                    <!-- Theme Toggle Button -->
                    <form method="POST" action="{{ route('toggle-theme') }}" class="inline">
                        @csrf
                        <button type="submit" class="ms-3 px-2 py-2 rounded-full bg-gray-200 dark:bg-gray-700">
                        ...
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <button class="flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition">
                                    <img class="size-8 rounded-full object-cover" src="{{ optional(Auth::user())->profile_photo_url }}" alt="{{ optional(Auth::user())->name }}" />
                                </button>
                            </x-slot>
                            <x-slot name="content">
