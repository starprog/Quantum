<div class="min-h-screen bg-gradient-to-br from-blue-900 via-indigo-800 to-purple-900 p-8 relative">
    ...
    <div class="max-w-2xl mx-auto bg-white/90 backdrop-blur-lg rounded-xl p-8 shadow-2xl border border-white/20 relative overflow-hidden">
        <!-- Loading overlay -->
        <div wire:loading wire:target="refreshVerse" class="absolute inset-0 bg-black/20 backdrop-blur-sm flex items-center justify-center z-50">
            ...
            <div class="mt-8 flex justify-center">
                <button wire:click="refreshVerse"
                    ...
                    <span class="flex items-center space-x-2">
                        <span>New Verse</span>
                        <svg wire:loading.remove wire:target="refreshVerse" class="w-5 h-5 text-blue-600 transition-transform group-hover:rotate-180 duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                        </svg>
                        <svg wire:loading wire:target="refreshVerse" class="animate-spin w-5 h-5 text-blue-600" fill="none" viewBox="0 0 24 24">
