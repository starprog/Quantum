<x-app-layout>
    ...
    <div class="z-10 flex flex-col items-center gap-6 p-6 w-full max-w-3xl mx-auto">
        ...
        <div id="player-card" class="flex flex-col items-center gap-4 w-full sm:w-96 bg-slate-900/60 backdrop-blur-md rounded-xl p-6 shadow-lg border border-slate-800/40">
            ...
            <div class="w-full flex gap-2 mt-3">
                <input id="file-input" type="file" accept="audio/*" class="flex-1 p-2 rounded bg-slate-800/40 text-slate-100" />
                <button id="play-toggle" class="px-3 py-2 rounded bg-sky-600 hover:bg-sky-700 text-white">Play</button>
            </div>
