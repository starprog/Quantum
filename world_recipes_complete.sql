-- ========================================
-- WORLD RECIPES - COMPLETE PHPMYADMIN IMPORT
-- ========================================
-- Import this file into phpMyAdmin to set up the complete database
-- 
-- Instructions:
-- 1. Open phpMyAdmin
-- 2. Click "Import" tab
-- 3. Choose this file (world_recipes_complete.sql)
-- 4. Click "Go" to import
-- ========================================

-- Create database and use it
CREATE DATABASE IF NOT EXISTS world_recipes CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE world_recipes;
...
-- Show all recipes by country
SELECT country, COUNT(*) as recipe_count 
FROM recipes 
GROUP BY country 
ORDER BY country;
...
-- ========================================
-- Your World Recipes database is ready with:
-- ✅ 15 authentic recipes (3 per country)
-- ✅ 5 countries: Japan, India, America, Mexico, Italy  
