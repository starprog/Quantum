...
class VerseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $verses = $query->orderBy('reference')->paginate(20);
        $categories = VerseCategory::orderBy('name')->get();

        return view('admin.verses.index', compact('verses', 'categories'));
    }
    ...
    {
        $categories = VerseCategory::orderBy('name')->get();
        return view('admin.verses.create', compact('categories'));
    }
     ...
     */
    public function toggleFeatured(Verse $verse)
    {
    ...
    {
        return view('admin.verses.import');
    }
    ...
    public function import(Request $request)
    {
        ...
        foreach ($rows as $index => $row) {
            ...
            $category = VerseCategory::where('name', $categoryName)->first();
            if (!$category) {
            ...
            if (Verse::where('reference', $reference)->exists()) {
                $skipped++;
                continue;
            }
